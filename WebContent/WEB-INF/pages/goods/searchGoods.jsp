        ...
        <div class="wrapper">
            <header class="navbar navbar-default navbar-fixed-top navbar-top">
                <div class="container">
                    ...
                    <li>
                        <a href="<%=basePath%>user/home" >${cur_user.username}</a>
                    </li>
                               <li class="dropdown">
                                <a class="dropdown-toggle" href="#" data-toggle="dropdown"><strong class="caret"></strong>&nbsp;操作</a>
                        ...
                        <div class="col-md-3 col-sm-3">
                            <div class="widget">
                                ...
                                <div class="widget-body">
                                    <ul class="trends">
                                        <li><a href="<%=basePath%>goods/catelog">最新发布 &nbsp;<span class="item-numbers"></span></a></li>
                                        <li><a href="<%=basePath%>goods/catelog/1">闲置数码 &nbsp;<span class="item-numbers"></span></a></li>
                                        <li><a href="<%=basePath%>goods/catelog/2">校园代步 &nbsp;<span class="item-numbers"></span></a></li>
                                        <li><a href="<%=basePath%>goods/catelog/3">电器日用 &nbsp;<span class="item-numbers"></span></a></li>
                                        <li><a href="<%=basePath%>goods/catelog/4">图书教材 &nbsp;<span class="item-numbers"></span></a></li>
                                        <li><a href="<%=basePath%>goods/catelog/5">美妆衣服 &nbsp;<span class="item-numbers"></span></a></li>
                                        <li><a href="<%=basePath%>goods/catelog/6">运动棋牌 &nbsp;<span class="item-numbers"></span></a></li>
                                        <li><a href="<%=basePath%>goods/catelog/7">票卷小物 &nbsp;<span class="item-numbers"></span></a></li>
                                    </ul>
                                </div>
                            </div>
